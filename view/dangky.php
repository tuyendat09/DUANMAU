              ...
              <form class="space-y-4 md:space-y-6" action="index.php?pg=register" method="POST">
                  ...
                  <div class="flex items-start">
                      ...
                      <div class="ml-3 text-sm">
                        <label for="terms" class="font-light text-gray-500 dark:text-gray-300">Tôi chấp nhận <a class="font-medium text-main hover:underline dark:text-primary-500" href="#">Điều khoản người dùng</a></label>
                      </div>
                  </div>
                  <button type="submit" name="register"  class="w-full text-black bg-prim hover:bg-main hover:text-white transition duration-300 ary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Tạo tài khoản</button>
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Đã có tài khoản? <a href="#" class="font-medium text-main hover:underline dark:text-primary-500">Đăng nhập</a>
                  </p>
              </form>
          </div>
      </div>
